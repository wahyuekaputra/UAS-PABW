...
class EditActivity : AppCompatActivity() {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                db.noteDao().addNote(
                    Note(
                        ...
                        edit_pengarang.text.toString(),
                        edit_tahun.text.toString(),
                        edit_penerbit.text.toString(),
    ...
    private fun getNote(){
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            edit_pengarang.setText( notes.pengarang)
            edit_tahun.setText( notes.tahun)
            edit_penerbit.setText( notes.penerbit)
